...
| R27 | Funcionários gerem o processo de reparação | Feito
...
| R61 | Gestores pesquisam pedidos por intervalo temporal | Feito
| R62 | Gestores pesquisam equipamentos por marca ou código | Feito
| R63 | Clientes listam os seus pedidos ordenados por data ou número | Feito
| R64 | Clientes pesquisam os seus pedidos por número ou estado | Feito
| R65 | Clientes listam os seus equipamentos ordenados por marca ou código | Feito
| R66 | Clientes pesquisam os seus equipamentos por marca ou código | Feito
| R67 | Funcionários listam os seus pedidos ordenados por data ou número | Feito
| R68 | Funcionários pesquisam os seus pedidos por número ou estado | Feito
...
| R76 | Listar conteúdo do log através da aplicação | Feito
| R77 | Pesquisar registos por utilizador no log | Feito
...
|===
| *Requisito* | *Descrição*	| *Estado*
| G1 | Completar e corrigir a aplicação iniciada no projeto 1 | Feito
| G2 | Utilizadores possuem foto, que pode ser inserida ou alterada em qualquer momento. Caso não seja definida, deve existir uma imagem por defeito no sistema | Feito
| G3 | No momento de registo deve ser enviado um email a informar que o registo foi realizado | Feito
...
| G5 | Após autenticação, deve surgir uma caixa de diálogo ou zona em realce na janela principal a indicar a existência de notificações, caso existam | Feito
| G6 | Deve ser possível imprimir um extrato das ações de um processo (datas e utilizadores que realizaram ações) | Feito
| G7 | Todas as listagens devem incluir barras de deslocamento | Feito
| G8 | Toda a interação com o utilizador deve ser realizada através de interfaces gráficas (JavaSwing / JavaFX). As interfaces devem ser intuitivas, limpas e claras | Feito
| G9 | Devem ser usadas componentes gráficas adequadas à informação: JList para listagens simples, JTable para listagens estruturadas | Feito
| G10 | Os formulários devem possuir tooltips de ajuda sobre cada elemento da interface | Feito
...
| G14 | O código deve estar harmonizado: a mesma funcionalidade deve estar implementada de forma idêntica e consistente ao longo de todo o código | Feito
|===